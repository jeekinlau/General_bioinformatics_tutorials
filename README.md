...
ml GCC/10.2.0  OpenMPI/4.0.5 SRA-Toolkit/2.10.9 parallel/20210322
...
THIS FAILED because the compute nodes are not connected to the internet. we need to run this on a local machine and upload later to the folders
